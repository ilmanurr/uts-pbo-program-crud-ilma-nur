                ...
                ?>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <input type="number" name="telepon" placeholder="08xxxxxxx" class="form-control">
                           
                            <label for="">Email</label>
                            <input type="email" name="email" placeholder="emailsiswa@email.com" class="form-control">
                            ...
                            <input type="submit" value="Tambahkan" class="btn btn-success form-control">
                        </form>
                    </div>
                </div>
            </div>
